...
#check_item("Remove lens cap and keep it close by")

Lens caps needs to be removed before taking photos and should be kept close by to prevent dust between takes.

Lens hoods can be used to protect the lens from scratches and reduce glare.

#check_item("Keep gear clean and dry")
...
#check_item("When changing batteries")

Check that the camera settings are still in effect after changing batteries (e.g. date and time). 

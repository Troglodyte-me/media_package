...
// Repository: https://github.com/Troglodyte-me/media_package/#set page(
paper: "a4",
...
width: 100%,
[
#text(fill: white, size: 18pt, weight: "bold")[Kamera & Medienausstattung] #v(2pt)
#text(fill: white.darken(10%), size: 11pt)[Camera & Media Equipment Inventory]
]
)
]#v(10pt)// Introductory Guide for Amateurs
#block(
fill: light-bg,
inset: 10pt,
...
radius: 4pt,
[
#text(weight: "bold", size: 10pt, fill: primary-color)[Hinweis für Einsteiger / Guide for Beginners]
#v(3pt)
...
== 1. Kameras / Cameras#let camera-data = csv("cameras_inventory.csv")#table(
...
== 2. Sensorgrößen & Brennweiten / Sensor Sizes & Perception#block(
width: 100%,
...
== 3. Objektive / Lenses#let lens-data = csv("lenses_inventory.csv")#table(
...
== 4. Filter & Adapter / Filters & Adapters#let filter-data = csv("filters_inventory.csv")#table(
...
)#v(16pt)// Section 5: Accessories & Miscellaneous
== 5. Sonstiges & Zubehör / Miscellaneous & Accessories#grid(
columns: (1fr, 1fr),
gutter: 12pt,
block(
fill: light-bg,
...
radius: 4pt,
[
#text(weight: "bold", fill: primary-color)[Adapter & Stromversorgung / Adapters & Power]
...
radius: 4pt,
[
#text(weight: "bold", fill: primary-color)[Licht & Stative / Lighting & Tripods]
- Blitzgeräte:
